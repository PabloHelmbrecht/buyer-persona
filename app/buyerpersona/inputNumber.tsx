...
function Contador({ min = 0, max = 100, defaultValue = 1, label = 'label', handleNumber: handleNumber }: InputNumberProps) {
    ...
    const buttonClasses = "bg-blue-500 hover:bg-blue-600 flex justify-center content-center items-center rounded-sm aspect-square h-7"
    const iconClases = "h-4 w-4 text-white font-bold"


    return (
        <div className="w-32 flex gap-4 items-center items">
            <Text textAlignment='text-center'><label>{label}</label></Text>
            <div className="flex justify-center content-center items-center gap-1">
            <button className={buttonClasses} onClick={handleDecrement}>
